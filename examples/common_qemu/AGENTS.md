...
`examples/common_qemu/` HAL and the virtio-net stepping-stone examples. It was
split out of the project root's `AGENTS.md` to keep the root guidance focused;
read root `AGENTS.md` first for the project's overall goals, build commands,
and process rules that apply everywhere.
