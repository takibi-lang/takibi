...
run_compile_error_test "match_int_nonexhaustive"  examples/match_int_nonexhaustive/match_int_nonexhaustive.tkb  examples/match_int_nonexhaustive/match_int_nonexhaustive.error
...
run_compile_error_test "view_linear_branch_missed" examples/view_linear_branch_missed/view_linear_branch_missed.tkb examples/view_linear_branch_missed/view_linear_branch_missed.error
...
run_forbid_trap_ok_test "field_never_consumed_wrong" examples/field_never_consumed_wrong/field_never_consumed_wrong.tkb
run_forbid_trap_ok_test "affine_param_never_consumed" examples/affine_param_never_consumed/affine_param_never_consumed.tkb
...
run_compile_error_test "dma_target_align_wrong" examples/dma_target_align_wrong/dma_target_align_wrong.tkb examples/dma_target_align_wrong/dma_target_align_wrong.error
...
run_compile_error_test "variant_linear_payload_missed" examples/variant_linear_payload_missed/variant_linear_payload_missed.tkb examples/variant_linear_payload_missed/variant_linear_payload_missed.error
run_compile_error_test "variant_existential_identity_wrong" examples/variant_existential_identity_wrong/variant_existential_identity_wrong.tkb examples/variant_existential_identity_wrong/variant_existential_identity_wrong.error
run_compile_error_test "variant_nonexhaustive_wrong" examples/variant_nonexhaustive_wrong/variant_nonexhaustive_wrong.tkb examples/variant_nonexhaustive_wrong/variant_nonexhaustive_wrong.error
...
run_compile_error_test "mutex_guard_identity_wrong" examples/mutex_guard_identity_wrong/mutex_guard_identity_wrong.tkb examples/mutex_guard_identity_wrong/mutex_guard_identity_wrong.error
run_compile_error_test "guard_pointer_after_unlock_wrong" examples/guard_pointer_after_unlock_wrong/guard_pointer_after_unlock_wrong.tkb examples/guard_pointer_after_unlock_wrong/guard_pointer_after_unlock_wrong.error
run_compile_error_test "tcp_conn_state_wrong" examples/tcp_conn_state_wrong/tcp_conn_state_wrong.tkb examples/tcp_conn_state_wrong/tcp_conn_state_wrong.error
run_compile_error_test "tcp_conn_dispatch_missed_wrong" examples/tcp_conn_dispatch_missed_wrong/tcp_conn_dispatch_missed_wrong.tkb examples/tcp_conn_dispatch_missed_wrong/tcp_conn_dispatch_missed_wrong.error
run_compile_error_test "stable_owner_without_guard_wrong" examples/stable_owner_without_guard_wrong/stable_owner_without_guard_wrong.tkb examples/stable_owner_without_guard_wrong/stable_owner_without_guard_wrong.error
run_compile_error_test "stable_owner_result_dropped_wrong" examples/stable_owner_result_dropped_wrong/stable_owner_result_dropped_wrong.tkb examples/stable_owner_result_dropped_wrong/stable_owner_result_dropped_wrong.error
run_compile_error_test "stable_owner_wrong_lock_wrong" examples/stable_owner_wrong_lock_wrong/stable_owner_wrong_lock_wrong.tkb examples/stable_owner_wrong_lock_wrong/stable_owner_wrong_lock_wrong.error
run_compile_error_test "net_rx_double_acquire_wrong" examples/net_rx_double_acquire_wrong/net_rx_double_acquire_wrong.tkb examples/net_rx_double_acquire_wrong/net_rx_double_acquire_wrong.error
run_compile_error_test "net_rx_use_after_release_wrong" examples/net_rx_use_after_release_wrong/net_rx_use_after_release_wrong.tkb examples/net_rx_use_after_release_wrong/net_rx_use_after_release_wrong.error
run_compile_error_test "region_authority_rebind_wrong" examples/region_authority_rebind_wrong/region_authority_rebind_wrong.tkb examples/region_authority_rebind_wrong/region_authority_rebind_wrong.error
...
run_compile_error_test "vm_page_map_free_after_map_wrong" examples/vm_page_map_free_after_map_wrong/vm_page_map_free_after_map_wrong.tkb examples/vm_page_map_free_after_map_wrong/vm_page_map_free_after_map_wrong.error
run_compile_error_test "vm_page_map_bytes_after_unmap_wrong" examples/vm_page_map_bytes_after_unmap_wrong/vm_page_map_bytes_after_unmap_wrong.tkb examples/vm_page_map_bytes_after_unmap_wrong/vm_page_map_bytes_after_unmap_wrong.error
run_compile_error_test "vm_page_map_double_map_wrong" examples/vm_page_map_double_map_wrong/vm_page_map_double_map_wrong.tkb examples/vm_page_map_double_map_wrong/vm_page_map_double_map_wrong.error
run_compile_error_test "vm_page_map_use_before_invalidate_wrong" examples/vm_page_map_use_before_invalidate_wrong/vm_page_map_use_before_invalidate_wrong.tkb examples/vm_page_map_use_before_invalidate_wrong/vm_page_map_use_before_invalidate_wrong.error
run_compile_error_test "smp_page_transfer_use_after_send_wrong" examples/smp_page_transfer_use_after_send_wrong/smp_page_transfer_use_after_send_wrong.tkb examples/smp_page_transfer_use_after_send_wrong/smp_page_transfer_use_after_send_wrong.error
run_compile_error_test "smp_page_transfer_wrong_space_wrong" examples/smp_page_transfer_wrong_space_wrong/smp_page_transfer_wrong_space_wrong.tkb examples/smp_page_transfer_wrong_space_wrong/smp_page_transfer_wrong_space_wrong.error
run_compile_error_test "multi_address_space_map_inactive_wrong" examples/multi_address_space_map_inactive_wrong/multi_address_space_map_inactive_wrong.tkb examples/multi_address_space_map_inactive_wrong/multi_address_space_map_inactive_wrong.error
run_compile_error_test "multi_address_space_wrong_active_wrong" examples/multi_address_space_wrong_active_wrong/multi_address_space_wrong_active_wrong.tkb examples/multi_address_space_wrong_active_wrong/multi_address_space_wrong_active_wrong.error
run_compile_error_test "multi_address_space_slot_wrong" examples/multi_address_space_slot_wrong/multi_address_space_slot_wrong.tkb examples/multi_address_space_slot_wrong/multi_address_space_slot_wrong.error
run_compile_error_test "vm_context_switch_old_active_wrong" examples/vm_context_switch_old_active_wrong/vm_context_switch_old_active_wrong.tkb examples/vm_context_switch_old_active_wrong/vm_context_switch_old_active_wrong.error
run_compile_error_test "vm_context_switch_wrong_space_wrong" examples/vm_context_switch_wrong_space_wrong/vm_context_switch_wrong_space_wrong.tkb examples/vm_context_switch_wrong_space_wrong/vm_context_switch_wrong_space_wrong.error
run_compile_error_test "vm_context_switch_stale_view_wrong" examples/vm_context_switch_stale_view_wrong/vm_context_switch_stale_view_wrong.tkb examples/vm_context_switch_stale_view_wrong/vm_context_switch_stale_view_wrong.error
run_compile_error_test "cpu_owner_mint_wrong" examples/cpu_owner_mint_wrong/cpu_owner_mint_wrong.tkb examples/cpu_owner_mint_wrong/cpu_owner_mint_wrong.error
run_compile_error_test "cpu_owner_reuse_wrong" examples/cpu_owner_reuse_wrong/cpu_owner_reuse_wrong.tkb examples/cpu_owner_reuse_wrong/cpu_owner_reuse_wrong.error
run_compile_error_test "exception_registration_mint_wrong" examples/exception_registration_mint_wrong/exception_registration_mint_wrong.tkb examples/exception_registration_mint_wrong/exception_registration_mint_wrong.error
run_compile_error_test "exception_registration_reuse_wrong" examples/exception_registration_reuse_wrong/exception_registration_reuse_wrong.tkb examples/exception_registration_reuse_wrong/exception_registration_reuse_wrong.error
run_compile_error_test "smp_task_migrate_use_after_quiesce_wrong" examples/smp_task_migrate_use_after_quiesce_wrong/smp_task_migrate_use_after_quiesce_wrong.tkb examples/smp_task_migrate_use_after_quiesce_wrong/smp_task_migrate_use_after_quiesce_wrong.error
run_compile_error_test "smp_task_migrate_before_shootdown_wrong" examples/smp_task_migrate_before_shootdown_wrong/smp_task_migrate_before_shootdown_wrong.tkb examples/smp_task_migrate_before_shootdown_wrong/smp_task_migrate_before_shootdown_wrong.error
run_compile_error_test "smp_task_migrate_wrong_core_wrong" examples/smp_task_migrate_wrong_core_wrong/smp_task_migrate_wrong_core_wrong.tkb examples/smp_task_migrate_wrong_core_wrong/smp_task_migrate_wrong_core_wrong.error
run_compile_error_test "page_split_double_wrong" examples/page_split_double_wrong/page_split_double_wrong.tkb examples/page_split_double_wrong/page_split_double_wrong.error
run_compile_error_test "page_join_nonadjacent_wrong" examples/page_join_nonadjacent_wrong/page_join_nonadjacent_wrong.tkb examples/page_join_nonadjacent_wrong/page_join_nonadjacent_wrong.error
run_compile_error_test "page_split_half_lost_wrong" examples/page_split_half_lost_wrong/page_split_half_lost_wrong.tkb examples/page_split_half_lost_wrong/page_split_half_lost_wrong.error
...
run_compile_error_test "stack_slice_escape_wrong" examples/stack_slice_escape_wrong/stack_slice_escape_wrong.tkb examples/stack_slice_escape_wrong/stack_slice_escape_wrong.error
run_compile_error_test "net_tx_release_while_in_flight_wrong" examples/net_tx_release_while_in_flight_wrong/net_tx_release_while_in_flight_wrong.tkb examples/net_tx_release_while_in_flight_wrong/net_tx_release_while_in_flight_wrong.error
run_compile_error_test "smp_handoff_use_after_send_wrong" examples/smp_handoff_use_after_send_wrong/smp_handoff_use_after_send_wrong.tkb examples/smp_handoff_use_after_send_wrong/smp_handoff_use_after_send_wrong.error
run_compile_error_test "smp_handoff_double_send_wrong" examples/smp_handoff_double_send_wrong/smp_handoff_double_send_wrong.tkb examples/smp_handoff_double_send_wrong/smp_handoff_double_send_wrong.error
...
run_test "checked_usize" examples/checked_usize/kernel.elf examples/checked_usize/checked_usize.expected
