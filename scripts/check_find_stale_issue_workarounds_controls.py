...
def main() -> int:
    ...
    report_pass(
        "stale-workarounds controls",
        "a named workaround, an unfinished claim, a TODO and a "
        "two-issue line are reported; a removed workaround negated on "
        "either line, three settled rationales, a string literal and a "
        "declared line are not; and editing a declared line brings it "
        "back",
        cases=SCENARIOS.ran)
    return 0
