#!/usr/bin/env bash
# Runs allcheck's independent QEMU and STM32 lanes in parallel after Makefile's
# allcheck-build has produced every artifact, including historical RPi5 builds,
