...
ALLOWED = {
    ("qemu-debug", "boot"):
        "the debug image crosses a 32 KiB allocation granule after the "
        "issue #483 contention evidence, so its linked usable-RAM start "
        "intentionally differs from the release QEMU image",
    ("qemu", "boot"):
