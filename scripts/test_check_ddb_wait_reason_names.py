...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("PASS ddb-wait-reason-names controls: the repository passes, and a "
          "reason encoded without a name, a name that no longer spells its "
          "case, a name for a code nothing encodes, a moved encoding and a "
          "reshaped namer are each refused")
    return 0
