...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("PASS documented-counts controls: the repository passes, a stale "
          "number and a tree that moved without it are each refused, a "
          "reworded sentence is refused rather than silently retiring the "
          "claim, and a number nothing declares is left alone")
    return 0
