...
RPI3_SMP_CORES=4 run_hw_test_rpi3 "page_split_join (rpi3)" "$REPO_ROOT/examples/page_split_join/kernel_rpi3.elf" "$REPO_ROOT/examples/page_split_join/page_split_join.expected" 5 30
...
run_hw_test_rpi3 "hvc_smoke (rpi3)" "$REPO_ROOT/examples/hvc_smoke/kernel_rpi3.elf" "$REPO_ROOT/examples/hvc_smoke/hvc_smoke.expected" 5 6
