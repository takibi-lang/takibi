...
def main():
    ...
    with tempfile.TemporaryDirectory() as name:
        ...
        cases = (
            ...
            ("the declared per-case PASS row",
             {"check_suite_output.py": COMPLIANT +
              '    print(f"PASS\\t{files}")\n'},
    ...
    print("PASS pass-line-counts controls: the repository passes, seven "
          "planted defects are caught, the declared exemption is honoured, "
          "and report_pass refuses a zero, negative, and missing count")
    return 0
