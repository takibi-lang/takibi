...
def main() -> int:
    ...
    print("PASS net-link-wait controls: both unreachable errnos are waited "
          "out and reported, a ready link is silent, a timeout and three "
          "delivered-request errors come straight back, and the deadline "
          "expires with the original error")
    return 0
