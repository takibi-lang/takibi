...
## qemubuild: build every artifact consumed by qemutest without running it
qemubuild: $(ALL_KERNELS) examples/fibonacci/kernel.debug.elf examples/dwarf_debug/kernel.debug.elf $(LINUX_BINS) examples/inline_check/inline_check.o
...
examples/http_server_sdcard_rtos/http_server_sdcard_rtos_stm32.o: examples/http_server_sdcard_rtos/http_server_sdcard_rtos.tkb $(COMMON_STM32_UART) $(COMMON_STM32_PRINT) $(COMMON_STM32_NVIC) $(COMMON_STM32_ETH) $(COMMON_STM32_NETCONFIG) $(COMMON_STM32_SDMMC) $(COMMON_STM32_ETH_SDMMC_REGS) $(COMMON_STM32_SCHEDULER) $(COMMON_SYNC) $(COMMON_RTOS) $(COMMON_GIC_REGS) $(COMMON_INET_CKSUM) $(COMMON_NETUTIL) $(COMMON_FAT12_GEOMETRY) $(COMMON_FAT12) $(COMMON_HTTP_SERVER) $(COMMON_HTTP_SDCARD) $(COMMON_STM32_FAT12_SDMMC) $(COMMON_RPI3_STUB) $(TAKIBI)
	$(TAKIBI) $(COMMON_STM32_UART) $(COMMON_STM32_PRINT_ONLY) $(COMMON_STM32_ETH) $(COMMON_STM32_SCHEDULER) $(COMMON_STM32_FAT12_SDMMC) $(COMMON_RPI3_STUB) $< --target $(STM32_TARGET) --cpu $(STM32_CPU) -o $@ --forbid-trap

examples/http_server_sdcard_rtos/http_server_sdcard_rtos_stm32.debug.o: examples/http_server_sdcard_rtos/http_server_sdcard_rtos.tkb $(COMMON_STM32_UART) $(COMMON_STM32_PRINT) $(COMMON_STM32_NVIC) $(COMMON_STM32_ETH) $(COMMON_STM32_NETCONFIG) $(COMMON_STM32_SDMMC) $(COMMON_STM32_ETH_SDMMC_REGS) $(COMMON_STM32_SCHEDULER) $(COMMON_SYNC) $(COMMON_RTOS) $(COMMON_GIC_REGS) $(COMMON_INET_CKSUM) $(COMMON_NETUTIL) $(COMMON_FAT12_GEOMETRY) $(COMMON_FAT12) $(COMMON_HTTP_SERVER) $(COMMON_HTTP_SDCARD) $(COMMON_STM32_FAT12_SDMMC) $(COMMON_RPI3_STUB) $(TAKIBI)
	$(TAKIBI) $(COMMON_STM32_UART) $(COMMON_STM32_PRINT_ONLY) $(COMMON_STM32_ETH) $(COMMON_STM32_SCHEDULER) $(COMMON_STM32_FAT12_SDMMC) $(COMMON_RPI3_STUB) $< --target $(STM32_TARGET) --cpu $(STM32_CPU) -g -o $@ --forbid-trap

examples/http_server_sdcard_rtos/http_server_sdcard_rtos_stm32.prof.o: examples/http_server_sdcard_rtos/http_server_sdcard_rtos.tkb $(COMMON_STM32_UART) $(COMMON_STM32_PRINT) $(COMMON_STM32_NVIC) $(COMMON_STM32_ETH) $(COMMON_STM32_NETCONFIG) $(COMMON_STM32_SDMMC) $(COMMON_STM32_ETH_SDMMC_REGS) $(COMMON_STM32_SCHEDULER) $(COMMON_SYNC) $(COMMON_RTOS) $(COMMON_GIC_REGS) $(COMMON_INET_CKSUM) $(COMMON_NETUTIL) $(COMMON_FAT12_GEOMETRY) $(COMMON_FAT12) $(COMMON_HTTP_SERVER) $(COMMON_HTTP_SDCARD) $(COMMON_STM32_FAT12_SDMMC) $(COMMON_RPI3_STUB) $(TAKIBI)
	$(TAKIBI) $(COMMON_STM32_UART) $(COMMON_STM32_PRINT_ONLY) $(COMMON_STM32_ETH) $(COMMON_STM32_SCHEDULER) $(COMMON_STM32_FAT12_SDMMC) $(COMMON_RPI3_STUB) $< --target $(STM32_TARGET) --cpu $(STM32_CPU) --profile-functions -o $@ --forbid-trap
...
# without --forbid-trap; the hardening commit will enable it here.
...
# examples/el1_smoke (GitHub issue #153 Stage 1): drops from EL2 to EL1,
# reusing the EL2 identity map as EL1&0's own stage 1 regime, then runs
# ordinary compiled Takibi code (el1_main) at EL1. See
# examples/common_rpi3/el1_asm.S's header comment for why the MMU
# reconfiguration cannot be a separate later step. RPi3-only, same
# TTBR0_EL2-reuse dependency as examples/vm_page_map's own exclusion.
COMMON_RPI3_EL1_ASM_S    := $(COMMON_RPI3_DIR)/el1_asm.S
COMMON_RPI3_EL1_ASM_O    := $(COMMON_RPI3_DIR)/el1_asm.o
COMMON_RPI3_EL1_ASM_EXTERN := $(COMMON_RPI3_DIR)/el1_asm_extern.tkb

$(COMMON_RPI3_EL1_ASM_O): $(COMMON_RPI3_EL1_ASM_S)
	$(LLVM_MC) --triple=$(RPI3_TARGET) --filetype=obj $< -o $@

RPI3_EL1_SMOKE_EXAMPLES := el1_smoke
...
# examples/hvc_smoke (GitHub issue #154): drops EL2 -> EL1 (on top of
# el1_smoke's already-proven mechanism), then calls back UP to EL2 via a
# real `hvc` trap boundary (hvc_asm.S's el1_hvc_entry/rpi3_hvc_call),
# proving only the trap-and-resume mechanism itself -- real EL2-level
# resource teardown is deliberately not attempted in this pass.
COMMON_RPI3_HVC_ASM_S    := $(COMMON_RPI3_DIR)/hvc_asm.S
COMMON_RPI3_HVC_ASM_O    := $(COMMON_RPI3_DIR)/hvc_asm.o
COMMON_RPI3_HVC_ASM_EXTERN := $(COMMON_RPI3_DIR)/hvc_asm_extern.tkb

$(COMMON_RPI3_HVC_ASM_O): $(COMMON_RPI3_HVC_ASM_S)
	$(LLVM_MC) --triple=$(RPI3_TARGET) --filetype=obj $< -o $@

RPI3_HVC_SMOKE_EXAMPLES := hvc_smoke
RPI3_HVC_SMOKE_OBJS := $(foreach e,$(RPI3_HVC_SMOKE_EXAMPLES),examples/$(e)/$(e)_rpi3.o)

$(RPI3_HVC_SMOKE_OBJS): examples/%_rpi3.o: examples/%.tkb $(COMMON_RPI3_EL1_ASM_EXTERN) $(COMMON_RPI3_HVC_ASM_EXTERN) $(COMMON_RPI3_UART) $(COMMON_RPI3_PRINT) $(TAKIBI)
	$(TAKIBI) $(COMMON_RPI3_UART) $(COMMON_RPI3_PRINT) $< --target $(RPI3_TARGET) --cpu $(RPI3_CPU) --forbid-trap -o $@
...
# EL0 payload that issues two real syscall numbers (write, exit) via
# `svc #0`, proving the real SVC trap boundary (el0_asm.S's el0_sync_entry)
# works for both the resume and terminate paths. Needs vm_page_map_core.tkb
# (map_page_el0_exec, mapping_bytes) and its own TLB-invalidate extern, plus
# both el0_asm.S's and el1_asm.S's extern declarations.
COMMON_RPI3_EL0_ASM_S    := $(COMMON_RPI3_DIR)/el0_asm.S
COMMON_RPI3_EL0_ASM_O    := $(COMMON_RPI3_DIR)/el0_asm.o
COMMON_RPI3_EL0_ASM_EXTERN := $(COMMON_RPI3_DIR)/el0_asm_extern.tkb

$(COMMON_RPI3_EL0_ASM_O): $(COMMON_RPI3_EL0_ASM_S)
	$(LLVM_MC) --triple=$(RPI3_TARGET) --filetype=obj $< -o $@

RPI3_EL0_SMOKE_EXAMPLES := el0_smoke
...
# VFS bridge.
COMMON_AARCH64_EL0_SHELL_CHILD_TEST_S      := $(COMMON_AARCH64_DIR)/el0_shell_child_test.S
COMMON_AARCH64_EL0_SHELL_CHILD_TEST_O      := $(COMMON_AARCH64_DIR)/el0_shell_child_test.o
COMMON_AARCH64_EL0_SHELL_CHILD_TEST_LD     := $(COMMON_AARCH64_DIR)/el0_shell_child_test.ld
COMMON_AARCH64_EL0_SHELL_CHILD_TEST_ELF    := $(COMMON_AARCH64_DIR)/el0_shell_child_test.elf
COMMON_AARCH64_EL0_SHELL_CHILD_TEST_IMAGE_S      := $(COMMON_AARCH64_DIR)/el0_shell_child_test_image.S
COMMON_AARCH64_EL0_SHELL_CHILD_TEST_IMAGE_O      := $(COMMON_AARCH64_DIR)/el0_shell_child_test_image.o
COMMON_AARCH64_EL0_SHELL_CHILD_TEST_IMAGE_EXTERN := $(COMMON_AARCH64_DIR)/el0_shell_child_test_image_extern.tkb

$(COMMON_AARCH64_EL0_SHELL_CHILD_TEST_O): $(COMMON_AARCH64_EL0_SHELL_CHILD_TEST_S)
	$(LLVM_MC) --triple=$(AARCH64_TARGET) --filetype=obj $< -o $@

# -pie: static-pie output (ET_DYN, base 0), same reasoning as
# el0_test_prog.elf's own build rule above.
$(COMMON_AARCH64_EL0_SHELL_CHILD_TEST_ELF): $(COMMON_AARCH64_EL0_SHELL_CHILD_TEST_O) $(COMMON_AARCH64_EL0_SHELL_CHILD_TEST_LD)
	$(LLD) -z max-page-size=4096 -pie -T $(COMMON_AARCH64_EL0_SHELL_CHILD_TEST_LD) $(COMMON_AARCH64_EL0_SHELL_CHILD_TEST_O) -o $@

$(COMMON_AARCH64_EL0_SHELL_CHILD_TEST_IMAGE_O): $(COMMON_AARCH64_EL0_SHELL_CHILD_TEST_IMAGE_S) $(COMMON_AARCH64_EL0_SHELL_CHILD_TEST_ELF)
	$(LLVM_MC) --triple=$(AARCH64_TARGET) --filetype=obj $< -o $@

RPI3_EL0_ELF_LOAD_EXAMPLES := el0_elf_load
RPI3_EL0_ELF_LOAD_OBJS := $(foreach e,$(RPI3_EL0_ELF_LOAD_EXAMPLES),examples/$(e)/$(e)_rpi3.o)

$(RPI3_EL0_ELF_LOAD_OBJS): examples/%_rpi3.o: examples/%.tkb examples/vm_page_map/vm_page_map_core.tkb $(COMMON_RPI3_TLB_ASM_EXTERN) $(COMMON_AARCH64_EL0_SHELL_ASM_EXTERN) $(COMMON_RPI3_EL0_TEST_IMAGE_EXTERN) $(COMMON_RPI3_UART) $(COMMON_RPI3_PRINT) $(TAKIBI)
	$(TAKIBI) $(COMMON_RPI3_UART) $(COMMON_RPI3_PRINT) $< --target $(RPI3_TARGET) --cpu $(RPI3_CPU) --forbid-trap -o $@
...
COMMON_AARCH64_BUSYBOX_APK        := $(COMMON_AARCH64_DIR)/busybox-static.apk
COMMON_AARCH64_BUSYBOX_STATIC     := $(COMMON_AARCH64_DIR)/busybox-static
COMMON_AARCH64_SHELL_INITRAMFS_CPIO := $(COMMON_AARCH64_DIR)/el0_shell_initramfs.cpio
COMMON_AARCH64_EL0_SHELL_IMAGE_S      := $(COMMON_AARCH64_DIR)/el0_shell_image.S
COMMON_AARCH64_EL0_SHELL_IMAGE_O      := $(COMMON_AARCH64_DIR)/el0_shell_image.o
COMMON_AARCH64_EL0_SHELL_IMAGE_EXTERN := $(COMMON_AARCH64_DIR)/el0_shell_image_extern.tkb

$(COMMON_AARCH64_BUSYBOX_APK):
...
$(COMMON_AARCH64_BUSYBOX_STATIC): $(COMMON_AARCH64_BUSYBOX_APK)
	tar -xzf $< -C $(COMMON_AARCH64_DIR) bin/busybox.static
	mv $(COMMON_AARCH64_DIR)/bin/busybox.static $@
	rmdir $(COMMON_AARCH64_DIR)/bin
...
$(COMMON_AARCH64_SHELL_INITRAMFS_CPIO): $(COMMON_AARCH64_BUSYBOX_STATIC)
	cd $(COMMON_AARCH64_DIR) && echo $(notdir $(COMMON_AARCH64_BUSYBOX_STATIC)) | cpio -o -H newc > $(notdir $@)

$(COMMON_AARCH64_EL0_SHELL_IMAGE_O): $(COMMON_AARCH64_EL0_SHELL_IMAGE_S) $(COMMON_AARCH64_SHELL_INITRAMFS_CPIO)
	$(LLVM_MC) --triple=$(AARCH64_TARGET) --filetype=obj $< -o $@
...
# and kernel rule.  Keep --forbid-trap off until the hardware baseline is
# committed, per the repository-wide baseline-then-hardening process.
RPI3_SMP_PAGE_TRANSFER_EXAMPLES := smp_page_transfer
...
# http_server_sdcard_rtos / kvs_server_sdcard_rtos (RPi3): the union of
# everything the milestone's earlier RPi3 steps proved separately --
# rtos_fatfs_sdcard's scheduler HAL + USB HAL combination (and the
# dma_prepare_rx/timer_asm_extern fixes that needed) plus
# http_server_sdcard's concurrent Ethernet + USB storage. Same
# scheduler-HAL/COMMON_STM32_STUB pair as RPI3_FATFS_RTOS_OBJS, same
# net+storage HAL list as RPI3_HTTP_SDCARD_OBJS.
RPI3_HTTP_SDCARD_RTOS_EXAMPLES := http_server_sdcard_rtos kvs_server_sdcard_rtos
RPI3_HTTP_SDCARD_RTOS_OBJS     := $(foreach e,$(RPI3_HTTP_SDCARD_RTOS_EXAMPLES),examples/$(e)/$(e)_rpi3.o)
...
RPI3_VM_PAGE_MAP_KERNELS := $(foreach e,$(RPI3_VM_PAGE_MAP_EXAMPLES) $(RPI3_VM_CONTEXT_SWITCH_EXAMPLES) $(RPI3_COW_EXAMPLES),examples/$(e)/kernel_rpi3.elf)
RPI3_VM_TASK_SWITCH_KERNELS := $(foreach e,$(RPI3_VM_TASK_SWITCH_EXAMPLES),examples/$(e)/kernel_rpi3.elf)
RPI3_SMP_TASK_MIGRATE_KERNELS := $(foreach e,$(RPI3_SMP_TASK_MIGRATE_EXAMPLES),examples/$(e)/kernel_rpi3.elf)
RPI3_PAGE_SPLIT_JOIN_KERNELS := $(foreach e,$(RPI3_PAGE_SPLIT_JOIN_EXAMPLES),examples/$(e)/kernel_rpi3.elf)
...
RPI3_SMP_SLAB_KERNELS := $(foreach e,$(RPI3_SMP_SLAB_EXAMPLES),examples/$(e)/kernel_rpi3.elf)
RPI3_EL1_SMOKE_KERNELS := $(foreach e,$(RPI3_EL1_SMOKE_EXAMPLES),examples/$(e)/kernel_rpi3.elf)
...
# el1_smoke additionally needs COMMON_RPI3_EL1_ASM_O linked in for
# rpi3_el1_enter (privileged EL1 register access cannot be called directly
# from takibi, same reasoning as COMMON_RPI3_TLB_ASM_O above).
$(RPI3_EL1_SMOKE_KERNELS): examples/%/kernel_rpi3.elf: \
    $(COMMON_RPI3_STARTUP_O) $(COMMON_RPI3_MMU_O) $(COMMON_RPI3_EL1_ASM_O) examples/%/$$*_rpi3.o $(COMMON_RPI3_LINK_LD)
	$(LLD) -T $(COMMON_RPI3_LINK_LD) $(COMMON_RPI3_STARTUP_O) $(COMMON_RPI3_MMU_O) $(COMMON_RPI3_EL1_ASM_O) examples/$*/$*_rpi3.o -o $@

# hvc_smoke additionally needs COMMON_RPI3_HVC_ASM_O linked in for
# rpi3_hvc_call/el1_hvc_entry (the EL1->EL2 call boundary).
$(RPI3_HVC_SMOKE_KERNELS): examples/%/kernel_rpi3.elf: \
    $(COMMON_RPI3_STARTUP_O) $(COMMON_RPI3_MMU_O) $(COMMON_RPI3_EL1_ASM_O) $(COMMON_RPI3_HVC_ASM_O) examples/%/$$*_rpi3.o $(COMMON_RPI3_LINK_LD)
	$(LLD) -T $(COMMON_RPI3_LINK_LD) $(COMMON_RPI3_STARTUP_O) $(COMMON_RPI3_MMU_O) $(COMMON_RPI3_EL1_ASM_O) $(COMMON_RPI3_HVC_ASM_O) examples/$*/$*_rpi3.o -o $@

# el0_smoke additionally needs COMMON_RPI3_EL1_ASM_O (the EL2->EL1 drop),
# COMMON_RPI3_EL0_ASM_O (the EL1->EL0 drop and real SVC entry), and
# COMMON_RPI3_TLB_ASM_O (map_page_el0_exec's tlb_invalidate) all linked in.
$(RPI3_EL0_SMOKE_KERNELS): examples/%/kernel_rpi3.elf: \
    $(COMMON_RPI3_STARTUP_O) $(COMMON_RPI3_MMU_O) $(COMMON_RPI3_EL1_ASM_O) $(COMMON_RPI3_EL0_ASM_O) $(COMMON_RPI3_TLB_ASM_O) examples/%/$$*_rpi3.o $(COMMON_RPI3_LINK_LD)
...
# COMMON_AARCH64_EL0_SHELL_IMAGE_O (the downloaded busybox-static image)
...
$(RPI3_EL0_SHELL_KERNELS): examples/%/kernel_rpi3.elf: \
    $(COMMON_RPI3_STARTUP_O) $(COMMON_RPI3_MMU_O) $(COMMON_RPI3_EL1_ASM_O) $(COMMON_RPI3_EL0_ASM_O) $(COMMON_RPI3_TLB_ASM_O) $(COMMON_RPI3_HVC_ASM_O) $(COMMON_RPI3_TIMER_ASM_O) $(COMMON_AARCH64_EL0_SHELL_IMAGE_O) $(COMMON_AARCH64_EL0_SHELL_CHILD_TEST_IMAGE_O) examples/%/$$*_rpi3.o $(COMMON_RPI3_LINK_LD)
	$(LLD) -T $(COMMON_RPI3_LINK_LD) $(COMMON_RPI3_STARTUP_O) $(COMMON_RPI3_MMU_O) $(COMMON_RPI3_EL1_ASM_O) $(COMMON_RPI3_EL0_ASM_O) $(COMMON_RPI3_TLB_ASM_O) $(COMMON_RPI3_HVC_ASM_O) $(COMMON_RPI3_TIMER_ASM_O) $(COMMON_AARCH64_EL0_SHELL_IMAGE_O) $(COMMON_AARCH64_EL0_SHELL_CHILD_TEST_IMAGE_O) examples/$*/$*_rpi3.o -o $@
...
$(RPI3_VM_TASK_SWITCH_KERNELS): examples/%/kernel_rpi3.elf: \
    $(COMMON_RPI3_STARTUP_O) $(COMMON_RPI3_MMU_O) $(COMMON_RPI3_TLB_ASM_O) \
    $(COMMON_RPI3_TIMER_ASM_O) examples/%/$$*_rpi3.o $(COMMON_RPI3_LINK_LD)
	$(LLD) -T $(COMMON_RPI3_LINK_LD) $(COMMON_RPI3_STARTUP_O) $(COMMON_RPI3_MMU_O) $(COMMON_RPI3_TLB_ASM_O) $(COMMON_RPI3_TIMER_ASM_O) examples/$*/$*_rpi3.o -o $@

$(RPI3_SMP_TASK_MIGRATE_KERNELS): examples/%/kernel_rpi3.elf: \
    $(COMMON_RPI3_STARTUP_O) $(COMMON_RPI3_MMU_O) $(COMMON_RPI3_TLB_ASM_O) \
    $(COMMON_RPI3_TIMER_ASM_O) $(COMMON_RPI3_SMP_O) examples/%/$$*_rpi3.o $(COMMON_RPI3_LINK_LD)
	$(LLD) -T $(COMMON_RPI3_LINK_LD) $(COMMON_RPI3_STARTUP_O) $(COMMON_RPI3_MMU_O) $(COMMON_RPI3_TLB_ASM_O) $(COMMON_RPI3_TIMER_ASM_O) $(COMMON_RPI3_SMP_O) examples/$*/$*_rpi3.o -o $@

$(RPI3_PAGE_SPLIT_JOIN_KERNELS): examples/%/kernel_rpi3.elf: \
    $(COMMON_RPI3_STARTUP_O) $(COMMON_RPI3_MMU_O) $(COMMON_RPI3_SMP_O) \
    examples/%/$$*_rpi3.o $(COMMON_RPI3_LINK_LD)
	$(LLD) -T $(COMMON_RPI3_LINK_LD) $(COMMON_RPI3_STARTUP_O) $(COMMON_RPI3_MMU_O) $(COMMON_RPI3_SMP_O) examples/$*/$*_rpi3.o -o $@

$(RPI3_SMP_PAGE_TRANSFER_KERNELS): examples/%/kernel_rpi3.elf: \
    $(COMMON_RPI3_STARTUP_O) $(COMMON_RPI3_MMU_O) $(COMMON_RPI3_TLB_ASM_O) \
    $(COMMON_RPI3_SMP_O) $(COMMON_SEM_ASM_O) examples/%/$$*_rpi3.o $(COMMON_RPI3_LINK_LD)
	$(LLD) -T $(COMMON_RPI3_LINK_LD) $(COMMON_RPI3_STARTUP_O) $(COMMON_RPI3_MMU_O) $(COMMON_RPI3_TLB_ASM_O) $(COMMON_RPI3_SMP_O) $(COMMON_SEM_ASM_O) examples/$*/$*_rpi3.o -o $@

$(RPI3_SMP_SLAB_KERNELS): examples/%/kernel_rpi3.elf: \
    $(COMMON_RPI3_STARTUP_O) $(COMMON_RPI3_MMU_O) $(COMMON_RPI3_SMP_O) \
    $(COMMON_SEM_ASM_O) examples/%/$$*_rpi3.o $(COMMON_RPI3_LINK_LD)
	$(LLD) -T $(COMMON_RPI3_LINK_LD) $(COMMON_RPI3_STARTUP_O) $(COMMON_RPI3_MMU_O) $(COMMON_RPI3_SMP_O) $(COMMON_SEM_ASM_O) examples/$*/$*_rpi3.o -o $@
...
$(KERNEL_RPI5_MAIN_O): $(KERNEL_RPI5_MAIN_TKB) $(KERNEL_PAGE_TKB) $(KERNEL_ADDRESS_SPACE_TKB) $(KERNEL_PROCESS_IMAGE_TKB) $(KERNEL_PROCESS_TKB) $(KERNEL_SYSCALL_TKB) $(KERNEL_INITRAMFS_TKB) $(KERNEL_ELF64_TKB) $(KERNEL_LOG_TKB) $(KERNEL_RPI5_MMU_EXTERN) $(KERNEL_RPI5_USER_EXTERN) $(KERNEL_INITRAMFS_EXTERN) $(KERNEL_RPI5_PCIE_TKB) \
...
$(KERNEL_RPI5_ELF): $(KERNEL_RPI5_ENTRY_O) $(KERNEL_RPI5_TIMER_O) $(KERNEL_RPI5_MMU_O) $(KERNEL_RPI5_USER_ENTRY_O) $(KERNEL_INITRAMFS_O) $(KERNEL_RPI5_MAIN_O) $(KERNEL_RPI5_LINK_LD)
	$(LLD) -T $(KERNEL_RPI5_LINK_LD) $(KERNEL_RPI5_ENTRY_O) $(KERNEL_RPI5_TIMER_O) $(KERNEL_RPI5_MMU_O) $(KERNEL_RPI5_USER_ENTRY_O) $(KERNEL_INITRAMFS_O) $(KERNEL_RPI5_MAIN_O) -o $@
...
COMMON_RPI5_ETH          := $(COMMON_RPI5_DIR)/eth.tkb
COMMON_RPI5_NETCONFIG    := $(COMMON_RPI5_DIR)/netconfig.tkb
...
## examples/common_rpi5/jtag_stub.img: the SD card's kernel_2712.img. Raw
## binary, not ELF -- same reasoning as examples/common_rpi3/jtag_stub.img.
examples/common_rpi5/jtag_stub.elf: $(COMMON_RPI5_JTAG_STUB_O) $(COMMON_RPI5_JTAG_STUB_LD)
	$(LLD) -T $(COMMON_RPI5_JTAG_STUB_LD) $(COMMON_RPI5_JTAG_STUB_O) -o $@
...
$(RPI5_NET_KERNELS): examples/%/kernel_rpi5.elf: $(COMMON_RPI5_STARTUP_O) $(COMMON_RPI5_MMU_O) $(COMMON_RPI5_TIMER_ASM_O) examples/%/$$*_rpi5.o $(COMMON_RPI5_LINK_LD)
...
examples/two_page_map/two_page_map_rpi5.o: examples/two_page_map/two_page_map_rpi5.tkb \
    examples/vm_page_map/vm_page_map_core_rpi5.tkb $(COMMON_RPI5_TLB_ASM_EXTERN) $(COMMON_RPI5_UART) $(COMMON_RPI5_PRINT) $(COMMON_RPI5_PCIE) $(TAKIBI)
	$(TAKIBI) $(COMMON_RPI5_UART) $(COMMON_RPI5_PRINT) $(COMMON_RPI5_PCIE) $< --target $(RPI5_TARGET) --cpu $(RPI5_CPU) $(RPI5_TAKIBI_FLAGS) -o $@

examples/two_page_map/kernel_rpi5.elf: \
...
## copy examples/common_rpi5/el0_asm.S's hand-written payload into).
## examples/el0_smoke/el0_smoke.tkb hardcodes RPi3's own
## `use "examples/common_rpi3/el0_asm_extern.tkb"`/
## `use "examples/common_rpi3/el1_asm_extern.tkb"` and 0x80000000 VA
## literal -- same "separate RPi5-specific source" reasoning as
## el1_smoke/hvc_smoke/vm_page_map above.
examples/el0_smoke/el0_smoke_rpi5.o: examples/el0_smoke/el0_smoke_rpi5.tkb \
    examples/vm_page_map/vm_page_map_core_rpi5.tkb $(COMMON_RPI5_TLB_ASM_EXTERN) $(COMMON_RPI5_EL0_ASM_EXTERN) $(COMMON_RPI5_EL1_ASM_EXTERN) $(COMMON_RPI5_UART) $(COMMON_RPI5_PRINT) $(COMMON_RPI5_PCIE) $(TAKIBI)
	$(TAKIBI) $(COMMON_RPI5_UART) $(COMMON_RPI5_PRINT) $(COMMON_RPI5_PCIE) $< --target $(RPI5_TARGET) --cpu $(RPI5_CPU) $(RPI5_TAKIBI_FLAGS) -o $@

examples/el0_smoke/kernel_rpi5.elf: \
...
examples/fat12_usbmsc_rpi5/fat12_usbmsc_rpi5_rpi5.o: examples/fat12_usbmsc_rpi5/fat12_usbmsc_rpi5.tkb $(COMMON_RPI5_UART) $(COMMON_RPI5_PRINT) $(COMMON_RPI5_PCIE) $(COMMON_RPI5_USB_XHCI) $(COMMON_RPI5_FAT12_USBMSC) $(COMMON_FAT12_GEOMETRY) $(COMMON_FAT12) $(COMMON_NETUTIL) $(TAKIBI)
...
examples/el0_shell/kernel_rpi5.elf: $(COMMON_RPI5_STARTUP_O) $(COMMON_RPI5_MMU_O) $(COMMON_RPI5_EL1_ASM_O) $(COMMON_RPI5_EL0_ASM_O) $(COMMON_RPI5_TLB_ASM_O) $(COMMON_RPI5_HVC_ASM_O) $(COMMON_RPI5_TIMER_ASM_O) $(COMMON_AARCH64_EL0_SHELL_IMAGE_O) $(COMMON_AARCH64_EL0_SHELL_CHILD_TEST_IMAGE_O) examples/el0_shell/el0_shell_rpi5.o $(COMMON_RPI5_LINK_LD)
	$(LLD) -T $(COMMON_RPI5_LINK_LD) $(COMMON_RPI5_STARTUP_O) $(COMMON_RPI5_MMU_O) $(COMMON_RPI5_EL1_ASM_O) $(COMMON_RPI5_EL0_ASM_O) $(COMMON_RPI5_TLB_ASM_O) $(COMMON_RPI5_HVC_ASM_O) $(COMMON_RPI5_TIMER_ASM_O) $(COMMON_AARCH64_EL0_SHELL_IMAGE_O) $(COMMON_AARCH64_EL0_SHELL_CHILD_TEST_IMAGE_O) examples/el0_shell/el0_shell_rpi5.o -o $@
...
examples/fatfs_sdcard/fatfs_sdcard_rpi5.o: examples/fatfs_sdcard/fatfs_sdcard.tkb $(COMMON_RPI5_UART) $(COMMON_RPI5_PRINT) $(COMMON_RPI5_PCIE) $(COMMON_RPI5_USB_XHCI) $(COMMON_RPI5_FAT12_USBMSC) $(COMMON_FAT12_GEOMETRY) $(COMMON_FAT12) $(COMMON_NETUTIL) $(TAKIBI)
...
examples/fatfs_sdcard/kernel_rpi5.elf: $(COMMON_RPI5_STARTUP_O) $(COMMON_RPI5_MMU_O) $(COMMON_RPI5_TIMER_ASM_O) examples/fatfs_sdcard/fatfs_sdcard_rpi5.o $(COMMON_RPI5_LINK_LD)
	$(LLD) -T $(COMMON_RPI5_LINK_LD) $(COMMON_RPI5_STARTUP_O) $(COMMON_RPI5_MMU_O) $(COMMON_RPI5_TIMER_ASM_O) examples/fatfs_sdcard/fatfs_sdcard_rpi5.o -o $@
...
examples/rtos_fatfs_sdcard/rtos_fatfs_sdcard_rpi5.o: examples/rtos_fatfs_sdcard/rtos_fatfs_sdcard.tkb $(COMMON_RPI5_UART) $(COMMON_RPI5_PRINT) $(COMMON_RPI5_PCIE) $(COMMON_RPI5_TIMER) $(COMMON_RPI5_USB_XHCI) $(COMMON_RPI5_FAT12_USBMSC) $(COMMON_FAT12_GEOMETRY) $(COMMON_FAT12) $(COMMON_NETUTIL) $(COMMON_STM32_STUB) $(TAKIBI)
...
examples/rtos_fatfs_sdcard/kernel_rpi5.elf: $(COMMON_RPI5_STARTUP_O) $(COMMON_RPI5_MMU_O) $(COMMON_RPI5_TIMER_ASM_O) $(COMMON_SEM_ASM_O) examples/rtos_fatfs_sdcard/rtos_fatfs_sdcard_rpi5.o $(COMMON_RPI5_LINK_LD)
	$(LLD) -T $(COMMON_RPI5_LINK_LD) $(COMMON_RPI5_STARTUP_O) $(COMMON_RPI5_MMU_O) $(COMMON_RPI5_TIMER_ASM_O) $(COMMON_SEM_ASM_O) examples/rtos_fatfs_sdcard/rtos_fatfs_sdcard_rpi5.o -o $@

examples/usb_msc_probe/usb_msc_probe_rpi5.o: examples/usb_msc_probe/usb_msc_probe_rpi5.tkb $(COMMON_RPI5_UART) $(COMMON_RPI5_PRINT) $(COMMON_RPI5_PCIE) $(COMMON_RPI5_USB_XHCI) $(TAKIBI)
...
examples/usb_msc_probe/kernel_rpi5.elf: $(COMMON_RPI5_STARTUP_O) $(COMMON_RPI5_MMU_O) $(COMMON_RPI5_TIMER_ASM_O) examples/usb_msc_probe/usb_msc_probe_rpi5.o $(COMMON_RPI5_LINK_LD)
	$(LLD) -T $(COMMON_RPI5_LINK_LD) $(COMMON_RPI5_STARTUP_O) $(COMMON_RPI5_MMU_O) $(COMMON_RPI5_TIMER_ASM_O) examples/usb_msc_probe/usb_msc_probe_rpi5.o -o $@
...
examples/http_server_sdcard_install/http_server_sdcard_install_rpi5.o: examples/http_server_sdcard_install/http_server_sdcard_install.tkb $(COMMON_RPI5_UART) $(COMMON_RPI5_PRINT) $(COMMON_RPI5_PCIE) $(COMMON_RPI5_USB_XHCI) $(COMMON_FAT12_GEOMETRY) $(TAKIBI)
	$(TAKIBI) $(COMMON_RPI5_UART) $(COMMON_RPI5_PRINT) $(COMMON_RPI5_PCIE) $(COMMON_RPI5_USB_XHCI) $< --target $(RPI5_TARGET) --cpu $(RPI5_CPU) $(RPI5_TAKIBI_FLAGS) -o $@
...
$(RPI5_NET_STORAGE_RTOS_OBJS): examples/%_rpi5.o: examples/%.tkb $(COMMON_RPI5_UART) $(COMMON_RPI5_PRINT) $(COMMON_RPI5_PCIE) $(COMMON_RPI5_TIMER) $(COMMON_RPI5_ETH) $(COMMON_RPI5_NETCONFIG) $(COMMON_RPI5_USB_XHCI) $(COMMON_RPI5_FAT12_USBMSC) $(COMMON_SYNC) $(COMMON_RTOS) $(COMMON_STM32_STUB) $(COMMON_INET_CKSUM) $(COMMON_NETUTIL) $(COMMON_FAT12_GEOMETRY) $(COMMON_FAT12) $(COMMON_HTTP_SERVER) $(TAKIBI)
...
examples/http_server_sdcard/kernel_rpi5.elf examples/http_server_sdcard_install/kernel_rpi5.elf: examples/%/kernel_rpi5.elf: $(COMMON_RPI5_STARTUP_O) $(COMMON_RPI5_MMU_O) $(COMMON_RPI5_TIMER_ASM_O) examples/%/$$*_rpi5.o $(COMMON_RPI5_LINK_LD)
	$(LLD) -T $(COMMON_RPI5_LINK_LD) $(COMMON_RPI5_STARTUP_O) $(COMMON_RPI5_MMU_O) $(COMMON_RPI5_TIMER_ASM_O) examples/$*/$*_rpi5.o -o $@

$(foreach e,$(RPI5_NET_STORAGE_RTOS_EXAMPLES),examples/$(e)/kernel_rpi5.elf): examples/%/kernel_rpi5.elf: $(COMMON_RPI5_STARTUP_O) $(COMMON_RPI5_MMU_O) $(COMMON_RPI5_TIMER_ASM_O) $(COMMON_SEM_ASM_O) examples/%/$$*_rpi5.o $(COMMON_RPI5_LINK_LD)
	$(LLD) -T $(COMMON_RPI5_LINK_LD) $(COMMON_RPI5_STARTUP_O) $(COMMON_RPI5_MMU_O) $(COMMON_RPI5_TIMER_ASM_O) $(COMMON_SEM_ASM_O) examples/$*/$*_rpi5.o -o $@
...
examples/vm_context_switch/vm_context_switch_rpi5.o: examples/vm_context_switch/vm_context_switch.tkb examples/vm_page_map/vm_page_map_core_rpi5.tkb $(COMMON_RPI5_TLB_ASM_EXTERN) $(COMMON_RPI5_UART) $(COMMON_RPI5_PRINT) $(COMMON_RPI5_PCIE) $(TAKIBI)
	$(TAKIBI) $(COMMON_RPI5_UART) $(COMMON_RPI5_PRINT) $(COMMON_RPI5_PCIE) examples/vm_page_map/vm_page_map_core_rpi5.tkb $< --target $(RPI5_TARGET) --cpu $(RPI5_CPU) $(RPI5_TAKIBI_FLAGS) -o $@
