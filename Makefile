...
RPI3_GENERIC_KERNELS   := $(filter-out $(RPI3_TIMER_ASM_KERNELS) $(RPI3_SEM_KERNELS) $(RPI3_VM_PAGE_MAP_KERNELS) $(RPI3_VM_TASK_SWITCH_KERNELS) $(RPI3_SMP_PAGE_TRANSFER_KERNELS),$(RPI3_KERNELS))
