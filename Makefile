...
RPI3_EXAMPLES += $(RPI3_IRQ_EXAMPLES) $(RPI3_RTC_EXAMPLES) $(RPI3_SCHED_EXAMPLES) $(RPI3_SCHED_SEM_EXAMPLES) $(RPI3_PAGE_POOL_EXAMPLES) $(RPI3_VM_PAGE_MAP_EXAMPLES) $(RPI3_VM_CONTEXT_SWITCH_EXAMPLES) $(RPI3_VM_TASK_SWITCH_EXAMPLES) $(RPI3_SMP_TASK_MIGRATE_EXAMPLES) $(RPI3_PAGE_SPLIT_JOIN_EXAMPLES) $(RPI3_SMP_PAGE_TRANSFER_EXAMPLES) $(RPI3_MULTI_ADDRESS_SPACE_EXAMPLES) $(RPI3_USB_EXAMPLES) $(RPI3_NET_EXAMPLES) $(RPI3_MSC_EXAMPLES) $(RPI3_FATFS_EXAMPLES) $(RPI3_FATFS_RTOS_EXAMPLES) $(RPI3_HTTP_SDCARD_EXAMPLES) $(RPI3_HTTP_SDCARD_RTOS_EXAMPLES)
...
RPI3_GENERIC_KERNELS   := $(filter-out $(RPI3_TIMER_ASM_KERNELS) $(RPI3_SEM_KERNELS) $(RPI3_VM_PAGE_MAP_KERNELS) $(RPI3_VM_TASK_SWITCH_KERNELS) $(RPI3_SMP_TASK_MIGRATE_KERNELS) $(RPI3_PAGE_SPLIT_JOIN_KERNELS) $(RPI3_SMP_PAGE_TRANSFER_KERNELS),$(RPI3_KERNELS))
