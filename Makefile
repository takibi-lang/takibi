...
$(KERNEL_RPI5_MAIN_O): $(KERNEL_RPI5_MAIN_TKB) $(KERNEL_PAGE_TKB) $(KERNEL_ADDRESS_SPACE_TKB) $(KERNEL_PROCESS_TKB) $(KERNEL_SYSCALL_TKB) $(KERNEL_LOG_TKB) $(KERNEL_RPI5_MMU_EXTERN) $(KERNEL_RPI5_USER_EXTERN) $(KERNEL_RPI5_PCIE_TKB) \
...
$(KERNEL_RPI5_ELF): $(KERNEL_RPI5_ENTRY_O) $(KERNEL_RPI5_TIMER_O) $(KERNEL_RPI5_MMU_O) $(KERNEL_RPI5_USER_ENTRY_O) $(KERNEL_RPI5_MAIN_O) $(KERNEL_RPI5_LINK_LD)
	$(LLD) -T $(KERNEL_RPI5_LINK_LD) $(KERNEL_RPI5_ENTRY_O) $(KERNEL_RPI5_TIMER_O) $(KERNEL_RPI5_MMU_O) $(KERNEL_RPI5_USER_ENTRY_O) $(KERNEL_RPI5_MAIN_O) -o $@
