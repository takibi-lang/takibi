...
$(KERNEL_RPI5_MAIN_O): $(KERNEL_RPI5_MAIN_TKB) $(KERNEL_PAGE_TKB) $(KERNEL_ADDRESS_SPACE_TKB) $(KERNEL_PROCESS_TKB) $(KERNEL_SYSCALL_TKB) $(KERNEL_INITRAMFS_TKB) $(KERNEL_ELF64_TKB) $(KERNEL_LOG_TKB) $(KERNEL_RPI5_MMU_EXTERN) $(KERNEL_RPI5_USER_EXTERN) $(KERNEL_INITRAMFS_EXTERN) $(KERNEL_RPI5_PCIE_TKB) \
