...
struct_intro:
  ...
  | STRUCT PUBLISH IDENT
    { Type_layout.begin_struct $3;
      ...
      ($3, false, None, false) }
  | STRUCT NO_WHOLE_STORE IDENT
    { Type_layout.begin_struct $3;
      No_whole_store_registry.mark $3;
      ($3, false, None, false) }
...
expr:
  ...
  | CONTAINS_STABLE_OWNER LPAREN t = type_expr RPAREN
    { { desc = ContainsStableOwner t; loc = $symbolstartpos } }
