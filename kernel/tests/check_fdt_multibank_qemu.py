...
MULTIBANK_EXPECTED = (
    ...
    b"regions=1 reservations=0 allocator_pages=261240")
...
LOW_MEMORY_EXPECTED = (
    ...
    b"regions=1 reservations=0 allocator_pages=31864")
...
DISCONTIGUOUS_MEMORY_EXPECTED = (
    ...
    b"regions=2 reservations=0 allocator_pages=195704")
...
def main() -> int:
    ...
    if not found:
        ...
        print("FAIL kernel/qemu FDT allocator sizing: expected memory line absent",
              file=sys.stderr)
        return 1
    print("PASS kernel/qemu FDT allocator sizing: 128 MiB DTB supplies 31864 pages")
