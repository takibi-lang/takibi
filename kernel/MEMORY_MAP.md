...
| `__bss_start` | `0x00640000` | `0x40440000` | linker script `.bss` | CHECKED (ELF) |
| `__bss_end` | `0x00b20030` | `0x40927420` | linker script `.bss` | CHECKED (ELF) |
| `boot_stack_run_bottom` | `0x00b28000` | `0x40928000` | linker script `.stack` | CHECKED (ELF) |
| `boot_stack_bottom` | `0x00b2c000` | `0x4092c000` | linker script `.stack` | CHECKED (ELF) |
| `boot_stack_top` | `0x00b30000` | `0x40930000` | linker script `.stack` | CHECKED (ELF) |
| `secondary_stack_run_bottom` | `0x00b30000` | `0x40930000` | linker script `.stack` | CHECKED (ELF) |
| `secondary_stack_bottom` | `0x00b34000` | `0x40934000` | linker script `.stack` | CHECKED (ELF) |
| `secondary_stack_top` | `0x00b38000` | `0x40938000` | linker script `.stack` | CHECKED (ELF) |
| `overflow_stack_run_bottom` | `0x00b38000` | `0x40938000` | linker script `.stack` | CHECKED (ELF) |
| `overflow_stack_bottom` | `0x00b3c000` | `0x4093c000` | linker script `.stack` | CHECKED (ELF) |
| `overflow_stack_top` | `0x00b40000` | `0x40940000` | linker script `.stack` | CHECKED (ELF) |
| `irq_stack_run_bottom` | `0x00b40000` | `0x40940000` | linker script `.stack` | CHECKED (ELF) |
| `irq_stack_bottom` | `0x00b44000` | `0x40944000` | linker script `.stack` | CHECKED (ELF) |
| `irq_stack_top` | `0x00b48000` | `0x40948000` | linker script `.stack` | CHECKED (ELF) |
| `usable_ram_start` | `0x00b48000` | `0x40948000` | linker script, `ALIGN(4096)` | CHECKED (ELF) |
